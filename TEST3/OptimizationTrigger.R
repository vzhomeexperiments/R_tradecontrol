...
# https://vladdsm.github.io/myblog_attempt/
...
# trading system project folder with file Setup.xlsx
path_PRJCT <- "C:/Users/fxtrams/Documents/000_TradingRepo/FALCON_F2/TEST/"
...
# 4. Last 20 orders on DEMO && pr.fact < 0.7 SUGGEST TO RE-TRAIN
